...
<body>
    <header>
        <div class="olive-branch left">
            <img src="./olive-1.png" alt="Left Olive Branch">
        </div>
        <div class="olive-branch right">
            <img src="./olive-2.png" alt="Right Olive Branch">
        </div>
        <div class="top">
    ...
    <div class="content">
        ...
        <div class="categories">
            <div class="category">
                <a href="/HomePage/Home/Sweet n Savory/sweet.html">
            ...
            <div class="category">
                <a href="/HomePage/Home/Sweet n Savory/savory.html">
